...
if [ ! -d "$ANYKERNEL_DIR" ]; then
  ...
  git clone --depth=1 -b master https://github.com/JOD-BUNNY07/AnyKernel3.git "$ANYKERNEL_DIR"
else
...
KERNEL_NAME="BunnyX-atoll-ResukiSU-Test-"
VERSION_NUMBER="v1.0."
...
if [ -n "$TELEGRAM_TOKEN" ]; then
  ...
  curl -s -X POST "https://api.telegram.org/bot$TELEGRAM_TOKEN/sendDocument" \
    ...
    -F caption="🔥 BunnyX-atoll-KSUN Kernel Build
